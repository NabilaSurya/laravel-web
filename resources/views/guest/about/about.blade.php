                    ...
                    <div
                        ...
                        <div class="text-center mb-10">
                            ...
                            <p class="text-sm leading-relaxed text-slate-600 max-w-3xl mx-auto">
                                Aplikasi ini dirancang untuk mempermudah pengelolaan data inventaris aset dan pendataan
                                informasi dasar warga di lingkungan Anda. Kami memastikan data tersimpan dengan rapi,
                        ...
                        <div class="flex flex-wrap -mx-3 mb-8">
                            ...
                            <div class="w-full lg:w-1/3 max-w-full px-3 mb-6">
                                <div
                                    class="module-card bg-white p-6 rounded-xl text-slate-700 border-t-4 border-purple-500 shadow-md">
                                    <i class="fas fa-tags text-2xl mb-3 text-purple-500"></i>
                                    <h3 class="font-bold text-lg mb-2">1. Manajemen Kategori Aset</h3>
                                    <p class="text-sm leading-relaxed text-slate-600">
                                        Modul ini berfungsi sebagai dasar klasifikasi. Tujuannya adalah mengelompokkan
                                        aset berdasarkan jenis (misalnya: Meja, Kendaraan, Elektronik) untuk memudahkan
                                        pengorganisasian dan pembuatan laporan spesifik.
                                    </p>
                            ...
                            <div class="w-full lg:w-1/3 max-w-full px-3 mb-6">
                                <div
                                    ...
                                    <p class="text-sm leading-relaxed text-slate-600">
                                        Ini adalah modul inti untuk melihat, menambah, dan mengelola semua aset. Data
                                        yang dicatat meliputi kondisi, kode unik, ID, dan deskripsi. Memastikan
                                        pemantauan barang inventaris yang akurat.
                                    </p>
                            ...
                            <div class="w-full lg:w-1/3 max-w-full px-3 mb-6">
                                <div
                                    ...
                                    <p class="text-sm leading-relaxed text-slate-600">
                                        Modul administratif untuk mencatat data pokok penduduk atau anggota komunitas.
                                        Informasi seperti NIK, nama, kontak, dan alamat sangat penting untuk kebutuhan
                        ...
                        <div class="relative mb-8 p-6 bg-gray-50 rounded-xl shadow-inner">
                            <div class="flex items-start mb-4">
                                <span
                                    class="bg-blue-500 text-white rounded-full h-8 w-8 flex items-center justify-center text-sm font-bold mr-3 flex-shrink-0">1</span>
                                <div>
                                    <p class="font-semibold text-slate-700">Input Kategori Dasar</p>
                                    <p class="text-sm text-slate-600">Pengguna memulai dengan mendefinisikan kategori
                                        (Contoh: "Peralatan Elektronik").</p>
                                </div>
                            </div>
                            <div class="flex items-start mb-4">
                                <span
                                    class="bg-blue-500 text-white rounded-full h-8 w-8 flex items-center justify-center text-sm font-bold mr-3 flex-shrink-0">2</span>
                                <div>
                                    <p class="font-semibold text-slate-700">Pendaftaran Aset Baru</p>
                                    <p class="text-sm text-slate-600">Setiap aset baru harus dikaitkan ke salah satu
                                        kategori yang telah dibuat sebelumnya.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <span
                                    class="bg-blue-500 text-white rounded-full h-8 w-8 flex items-center justify-center text-sm font-bold mr-3 flex-shrink-0">3</span>
                                <div>
                                    <p class="font-semibold text-slate-700">Pengelolaan & Pemeliharaan</p>
                                    <p class="text-sm text-slate-600">Data aset dapat dimodifikasi (Edit), diperbarui
                                        statusnya, atau dihapus jika aset tersebut sudah tidak ada.</p>
                                </div>
                            </div>
                            <i class="fas fa-long-arrow-alt-down text-3xl text-gray-300 absolute top-10 left-12 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-50"
                                style="top: 2.8rem; left: 2.5rem;"></i>
                            <i class="fas fa-long-arrow-alt-down text-3xl text-gray-300 absolute top-10 left-12 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-50"
                                style="top: 7.3rem; left: 2.5rem;"></i>
                        </div>
