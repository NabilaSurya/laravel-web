    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
        ...
        <div class="bg-white shadow-2xl rounded-xl p-8 border border-gray-100">
            ...
            <div class="mb-8 pb-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-500 mt-1">Perbarui detail perpindahan atau perubahan status aset.</p>
            </div>

            <form action="{{ route('mutasi-aset.update', $mutasi->mutasi_id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <select name="aset_id" id="aset_id" required
                            ...
                            @foreach ($asets as $aset)
                                <option value="{{ $aset->aset_id }}"
                                    {{ $aset->aset_id == $mutasi->aset_id ? 'selected' : '' }}>
                                    {{ $aset->nama_aset }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal" id="tanggal" value="{{ $mutasi->tanggal }}" required
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition">
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <input type="text" name="jenis_mutasi" id="jenis_mutasi" value="{{ $mutasi->jenis_mutasi }}"
                            required
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="4"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition">{{ $mutasi->keterangan }}</textarea>
                </div>
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa fa-sync-alt mr-1"></i> Update Mutasi
                    </button>
                </div>
            </form>
        </div>
